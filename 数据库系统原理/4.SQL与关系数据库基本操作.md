...
![image-20220309224400926](https://gitee.com/Dreams_rj/dreams-img/raw/master/imgs/image-20220309224400926.png)
...
```sql
alter table db_name.table_name add column city not null default '武汉' after cust_sex;
```
...
```sql
alter table db_name.table_name
rename to db_name.new_table_name;
```
...
![image-20220312150844586](https://gitee.com/Dreams_rj/dreams-img/raw/master/imgs/image-20220312150844586.png)
